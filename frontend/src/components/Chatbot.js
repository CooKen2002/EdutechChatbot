  ...
  return (
    <div className="chatbot-wrapper">
      <div className="header">
        <div className="learning-path"><button>Khóa học của tôi</button></div>
        <div className="user-section">
          <div className="user-avatar"><img src="https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp" alt="Avatar" /></div>
